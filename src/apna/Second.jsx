    ...
    <>
      ...
      <div className="flex flex-wrap gap-6 mt-[6rem] justify-center">
        {products.slice(0, visibleCount).map((item) => (
          <div
            key={item.id}
            className="h-[20rem] w-[16%] grid bg-gray-100 rounded-[10px] shadow-md">
            <img
...
//   return (
//     <>
//       <h1 className="text-2xl font-bold mt-[2rem] ml-[3rem]">
//         Make EveryDay a staycation
//       </h1>
...
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-[3rem] px-4">
//         {products.slice(0, visibleCount).map((item) => (
//           <div
//             key={item.id}
//             className="h-[22rem] grid bg-gray-100 rounded-[10px] shadow-md p-4"
//           >
//             <img
//               className="h-[10rem] w-[50%] rounded-[50%] mt-[1rem] mx-auto"
//               src={item.img}
//               alt=""
//             />
//             <h1 className="text-center mt-3 mb-2 font-semibold">{item.des}</h1>
//             <button
//               onClick={() => goNav()}
//               className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 w-[60%] mx-auto mt-auto"
//             >
//               {item.button}
//             </button>
//           </div>
